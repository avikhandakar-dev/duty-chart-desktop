...
async function runComprehensiveTest() {
  ...
  if (afterRefreshCheck.count >= 3) {
    ...
    console.log(
      `Expected at least 3 indicators, got ${afterRefreshCheck.count}`,
    );
  }
...
async function quickTest() {
  ...
  console.log(
    ...
    typeof window.restoreActiveSaveAfterRefresh,
  );
  ...
  return {
    ...
    restoreFunctionAvailable:
      typeof window.restoreActiveSaveAfterRefresh === "function",
